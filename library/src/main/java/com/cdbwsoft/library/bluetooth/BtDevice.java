	...
	class ConnectThread extends Thread {
		...
		public void run() {
			...
			try {
				...
				if (mSecure) {
					mBluetoothSocket = mDevice.createRfcommSocketToServiceRecord(AppConfig.UUID_SECURE);
				} else {
					mBluetoothSocket = mDevice.createInsecureRfcommSocketToServiceRecord(AppConfig.UUID_INSECURE);
				}
				if (mBluetoothSocket == null) {
					mState = STATE_IDLE;
