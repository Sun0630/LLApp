...
/**
 * Created by liulei on 2016/6/18.
 */
public class RoundWhiteImageView extends ImageView {

    private int mBorderThickness = 0;
    private Context mContext;
//    private int defaultColor = 0xFFFFFFFF;
    private int defaultColor = 0xF8F8F8;
    ...
    public RoundWhiteImageView(Context context) {
        super(context);
        mContext = context;
    }

    public RoundWhiteImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setCustomAttributes(attrs);
    }

    public RoundWhiteImageView(Context context, AttributeSet attrs, int defStyle) {
