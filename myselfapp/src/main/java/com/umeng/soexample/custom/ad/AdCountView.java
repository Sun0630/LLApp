package com.umeng.soexample.custom.ad;
...
public class AdCountView extends View implements CountAnimationUtil.OnInterpolatedTimeChanged {
    ...
    private void init(TypedArray typedArray) {
        ...
        if (!TextUtils.isEmpty(typedArray.getString(R.styleable.AdCountView_adText))) {
            mText = typedArray.getString(R.styleable.AdCountView_adText);
        }
        mTextSize = typedArray.getInt(R.styleable.AdCountView_adTextSize, 10);
        mbackgroundColor = typedArray.getColor(R.styleable.AdCountView_adBackgroundColor, 0x80000000);
        mOutRingColor = typedArray.getColor(R.styleable.AdCountView_adOutRingColor, 0xFF00FF00);
        mTextColor = typedArray.getColor(R.styleable.AdCountView_adTextColor, 0x4D000000);
        adTimeMillis = typedArray.getInt(R.styleable.AdCountView_adDuration, 5000);
        typedArray.recycle();

        mTextSize = DensityUtils.dp2px(mTextSize);
        ...
        mOutStrokeWidth = DensityUtils.dp2px(mOutStrokeWidth);
    ...
    public void setTextSize(int textSize) {
        mTextPaint.setTextSize(DensityUtils.dp2px(textSize));
    }
