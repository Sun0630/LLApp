...
/**
 * Created by LiuLei on 2017/5/24.
 */
...
public class TemperatureView extends View{
    ...
    private String panelText = "当前温度";//刻度盘上的文字
    ...
    private void drawPanel(Canvas canvas) {
        ...
        drawPointer(canvas);
        // 绘制文字
        drawPanelText(canvas,panelText);
    }
     ...
     * @param canvas
     */
    private void drawPanelText(Canvas canvas,String text) {
...
//        panelTextPaint.setColor(tempTextColor);
    ...
    public void setTikeCount(int mTikeCount) {
        this.mTikeCount = mTikeCount;
    }
}
