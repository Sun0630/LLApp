...
public class VideoLiveWallpaper extends WallpaperService {
    ...
    class VideoEngine extends Engine {
        ...
        public void onCreate(SurfaceHolder surfaceHolder) {
            ...
            LogUtils.d(TAG,"VideoEngine#onCreate");
        ...
        public void onDestroy() {
            LogUtils.d(TAG,"VideoEngine#onDestroy");
        ...
        public void onVisibilityChanged(boolean visible) {
            LogUtils.d(TAG,"VideoEngine#onVisibilityChanged visible = " + visible);
            if (visible) {
                mMediaPlayer.start();
            } else {
                mMediaPlayer.pause();
        ...
        public void onSurfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            LogUtils.d(TAG,"VideoEngine#onSurfaceChanged ");
            super.onSurfaceChanged(holder, format, width, height);
        }

        @Override
        public void onSurfaceDestroyed(SurfaceHolder holder) {
            LogUtils.d(TAG,"VideoEngine#onSurfaceDestroyed ");
