...
package com.example.myselfapp.floatView;
...
public class FloatView extends FrameLayout implements OnTouchListener {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == HANDLER_TYPE_HIDE_LOGO) {
                ...
                if (mCanHide) {
                    mCanHide = false;
                    if (mIsRight) {
                        mIvFloatLogo.setImageResource(R.mipmap.pj_image_float_right);
                    } else {
                        mIvFloatLogo.setImageResource(R.mipmap.pj_image_float_left);
                    }
    ...
    private void getDatas() {
        mDatas.add(R.mipmap.ai1);
        mDatas.add(R.mipmap.ai2);
        mDatas.add(R.mipmap.ai2);
    }
    ...
    private View createView(final Context context) {
        ...
        recycle_horizontal = (RecyclerView) rootFloatView.findViewById(R.id.recycle_horizontal);
        no_ad_tip = (TextView) rootFloatView.findViewById(R.id.no_ad_tip);
        //设置布局管理器
        ...
        recycle_horizontal.setAdapter(mAdapter);
//        mAdapter.setOnItemClickListener(new OnItemClickListener() {
//            @Override
//            public void OnItemClick(View view, int position) {
//                if (mDatas.size() > 0) {
//                    Intent intent = new Intent();
//                    intent.setData(Uri.parse("http;//baidu.com"));//Url 就是你要打开的网址
...
//        });
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mIvFloatLogo.setImageResource(R.mipmap.pj_image_float_logo);
                mWmParams.alpha = 1f;
                mWindowManager.updateViewLayout(this, mWmParams);
                mDraging = false;
                break;
    ...
    private void refreshFloatMenu(boolean right) {
        if (right) {
            ...
            LinearLayout.LayoutParams paramsMenuAccount = (LinearLayout.LayoutParams) recycle_horizontal.getLayoutParams();
            paramsMenuAccount.rightMargin = padding52;
            paramsMenuAccount.leftMargin = padding;
            recycle_horizontal.setLayoutParams(paramsMenuAccount);
...
//            LinearLayout.LayoutParams paramsMenuFb = (LinearLayout.LayoutParams) recycle_horizontal.getLayoutParams();
//            paramsMenuFb.rightMargin = padding;
//            paramsMenuFb.leftMargin = padding;
//            recycle_horizontal.setLayoutParams(paramsMenuFb);
        }
    }
    ...
    public class GalleryAdapter extends
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view = mInflater.inflate(R.layout.ad_item,
                    viewGroup, false);
            ViewHolder viewHolder = new ViewHolder(view);

            viewHolder.mImg = (RoundWhiteImageView) view
                    .findViewById(R.id.ad_image);
            viewHolder.mTxt = (TextView) view
                    .findViewById(R.id.ad_name);
            return viewHolder;
        }
