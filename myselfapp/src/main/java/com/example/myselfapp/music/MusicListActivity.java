...
import com.example.myselfapp.custom.AlphaForegroundColorSpan;
import com.example.myselfapp.custom.KenBurnsView;
import com.example.myselfapp.custom.ScrollListView;
import com.example.myselfapp.custom.floatView.FloatingActionButton;
import com.example.myselfapp.custom.floatView.ScrollDirectionListener;
...
public class MusicListActivity extends Activity implements OnItemClickListener {
    ...
    private AndroidApp myApplication;
...
//        });
     ...
     */
    protected void init() {
        myApplication = AndroidApp.getInstance();
        list = new ArrayList<>();
