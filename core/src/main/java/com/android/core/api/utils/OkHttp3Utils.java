package com.android.core.api.utils;
...
import com.android.core.api.cook.PersistentCookieStore;
...
public class OkHttp3Utils {
    ...
    //设置缓存目录
    private static File cacheDirectory = new File(BaseApplication.getInstance().getCacheDir().getAbsolutePath(), "MyCache");
    ...
    private static class MyIntercepter implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!isNetworkReachable(BaseApplication.getInstance())) {
                Toast.makeText(BaseApplication.getInstance(), "暂无网络", Toast.LENGTH_SHORT).show();
